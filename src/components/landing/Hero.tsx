...
export default function Hero() {
  ...
  const handleWhatsapp = () => {
    window.open(
      `https://wa.me/${siteConfig.whatsappNumber}?text=Hola! Me interesa contratar sus servicios de drones para un evento.`,
      '_blank'
    )
  }
    ...
    <section id="hero" className={styles.hero}>
      ...
      <div className={`container ${styles.content}`}>
        ...
        <h1 className={styles.title}>
          ...
          <br />
          <span className={styles.titleGrad}>
      ...
      {/* Drone decoration */}
      <div className={styles.droneDecor}>🚁</div>
    </section>
  )
}
